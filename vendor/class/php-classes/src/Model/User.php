	    		...
	    		public static function getForgot($email, $inadmin = true)
		{
		     ...
		     else
		     {
		         ...
		         else
		         {
		             ...
		             if ($inadmin === true) {
		                 $link = "http://www.mycontrole.com.br/admin/forgot/reset?code=$result";
		             } else {
		                 $link = "http://www.mycontrole.com.br/forgot/reset?code=$result";
		             }
		             $mailer = new Mailer($data['desemail'], $data['desperson'], "Redefinir senha da MY CONTROLE", "forgot", array(
		                 "name"=>$data['desperson'],
		                 "link"=>$link
		             ));
		             $mailer->send();
