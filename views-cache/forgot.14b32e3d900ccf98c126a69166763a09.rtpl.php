...
<head>
  ...
  <title>Reset de senha MY CONTROLE</title>
  <!--[if !mso]>
      <!-- -->
...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 ...
 padding-bottom: 9px; padding-left: 18px;' valign="top">
                                <a href="https://www.mycontrole.com.br" style="mso-line-height-rule: exactly;
 ...
 padding-left: 0px; padding-top: 0; padding-bottom: 0; text-align:center;" valign="top">
                                <a class="" href="https://www.mycontrole.com.br" style="mso-line-height-rule:
 ...
 padding: 0'><span style="text-transform:uppercase">Reset</span></h1>
 ...
 padding: 0'><span style="text-transform:uppercase">sua senha?</span></h2>
 ...
 color: #2a2a2a; font-family: "Asap", Helvetica, sans-serif; font-size: 16px;
 line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
 padding-bottom: 9px; padding-left: 18px;' valign="top">Olá <?php echo htmlspecialchars( $name, ENT_COMPAT, 'UTF-8', FALSE ); ?>.
                                <br></br>
                              </td>
                            </tr>
                            <tr>
 ...
 color: #2a2a2a; font-family: "Asap", Helvetica, sans-serif; font-size: 16px;
 line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
 padding-bottom: 9px; padding-left: 18px;' valign="top">Para redifinir a sua senha acesso o link abaixo!.
                                <br></br>
                              </td>
                            </tr>
                          </tbody>
 ...
 padding-right:48px; padding-bottom:24px; padding-left:48px;" valign="middle">
                                        <a class="mcnButton " href="<?php echo htmlspecialchars( $link, ENT_COMPAT, 'UTF-8', FALSE ); ?>" style="mso-line-height-rule: exactly;
 ...
 #FFFFFF; text-transform:uppercase;" target="_blank" invitation">Reset password</a>
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
