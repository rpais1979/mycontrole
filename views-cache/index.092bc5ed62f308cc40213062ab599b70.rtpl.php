...
<head>
    ...
    <!-- Plugin-CSS -->
    <link rel="stylesheet" href="/vendor/res/site/css/bootstrap.min.css">
    <link rel="stylesheet" href="/vendor/res/site/css/owl.carousel.min.css">
    <link rel="stylesheet" href="/vendor/res/site/css/themify-icons.css">
    <link rel="stylesheet" href="/vendor/res/site/css/magnific-popup.css">
    <link rel="stylesheet" href="/vendor/res/site/css/animate.css">
    <!-- Main-Stylesheets -->
    <link rel="stylesheet" href="/vendor/res/site/css/normalize.css">
    <link rel="stylesheet" href="/vendor/res/site/style.css">
    <link rel="stylesheet" href="/vendor/res/site/css/responsive.css">
    <script src="/vendor/res/site/js/vendor/modernizr-2.8.3.min.js"></script>
...
<body data-spy="scroll" data-target="#primary-menu">
        ...
        <div class="container">
            ...
            <nav class="collapse navbar-collapse" id="primary-menu">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="/admin/login">Acesso ao Sistema</a></li>
                </ul>
            </nav>
        </div>
    </div>
    ...
    <!--Vendor-JS-->
    <script src="/vendor/res/site/js/vendor/jquery-1.12.4.min.js"></script>
    <script src="/vendor/res/site/js/vendor/bootstrap.min.js"></script>
    <!--Plugin-JS-->
    <script src="/vendor/res/site/js/owl.carousel.min.js"></script>
    <script src="/vendor/res/site/js/contact-form.js"></script>
    <script src="/vendor/res/site/js/jquery.parallax-1.1.3.js"></script>
    <script src="/vendor/res/site/js/scrollUp.min.js"></script>
    <script src="/vendor/res/site/js/magnific-popup.min.js"></script>
    <script src="/vendor/res/site/js/wow.min.js"></script>
    <!--Main-active-JS-->
    <script src="/vendor/res/site/js/main.js"></script>
</body>
