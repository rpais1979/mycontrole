...
<head>
  ...
  <title>MY CONTROLE | Log in</title>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="/vendor/res/admin/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="index.html"><b>MY</b>CONTROLE</a>
  </div>
  <!-- /.login-logo -->
...
<!-- iCheck -->
<script src="/vendor/res/admin/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
