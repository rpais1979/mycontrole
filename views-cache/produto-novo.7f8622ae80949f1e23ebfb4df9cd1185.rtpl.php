...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="/admin/users">Produtos</a></li>
            ...
            <div class="col-md-12">
                ...
                <div class="nav-tabs-custom" role="tablist">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab_2" data-toggle="tab">Estoque/Variações</a></li>
                        <li><a href="#tab_3" data-toggle="tab">Fiscal</a></li>
                        <li><a href="#tab_4" data-toggle="tab">Formação de Preço</a></li>
                        <li><a href="#tab_5" data-toggle="tab">Fornecedores</a></li>
                        ...
                        <div class="tab-pane active" id="tab_1">
                            <div style="padding-top:5px;">
                                <form class="form-horizontal" name="form_dados_pessoais" action="" method="POST">
                                    ...
                                    <div class="form-group"> 
                                        <div class="col-sm-3">
                                            <label for="exampleInputEmail1">Movimenta Estoque</label>
                                            <select class="form-control" name="contribuinte_id">
                                                <option value="">Selecione...</option>
                                        ...
                                        <div class="col-sm-3">    
                                            <label for="exampleInputEmail1">Habilitar Nota Fiscal</label>
                                            <select class="form-control" name="contribuinte_id">
                                                <option value="">Selecione...</option>
                                                <option value="1">Sim</option>
                                                <option value="2">Não</option>
                                            ...
                                            <div class="col-sm-3">
                                            <label for="exampleInputEmail1">Possui Variação</label>
                                            <select class="form-control" name="contribuinte_id">
                                                <option value="">Selecione...</option>
                                                <option value="1">Sim</option>
                                                <option value="2">Não</option>
                                            ...
                                            <div class="col-sm-3">
                                            <label for="exampleInputEmail1">Possui Composição</label>
                                            <select class="form-control" name="contribuinte_id">
                                                <option value="">Selecione...</option>
                                                <option value="1">Sim</option>
                                                <option value="2">Não</option>
