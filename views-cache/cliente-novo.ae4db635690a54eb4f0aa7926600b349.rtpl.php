        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-body">
                        <form class="form-horizontal" name="form_dados_cliente_novos" action="" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-3">
                                    ...
                                    <input type="text" name="dtnascimento" class="form-control" placeholder="Data de Nascimento" style="display:none;">
                                </div>
                                <div class="col-xs-3">
                            ...
                            <div style="padding-top:10px;"></div>
                            <form class="form-horizontal" name="form_dados_cliente_contato" style="display:none;">
                                <div class="box-body">                                        
                                ...
                                <div class="box-header with-border">
                                    <h3 class="box-title">Obsevação</h3>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
...
<script type="text/javascript">
    ...
    function valor(tipo) {
        if (tipo == "cpf") {
            ...
            document.form_dados_cliente_novos.desnome.style.display = "block";
            $('#desnome').show();
            //Apresentar campo Nome
            document.form_dados_cliente_novos.descpf.style.display = "block";
            $('#descpf').show();
            //Apresentar campo Nome
            document.form_dados_cliente_novos.desrg.style.display = "block";
            $('#desrg').show();
            //Apresentar campo Nome
            document.form_dados_cliente_novos.dtnascimento.style.display = "block";
            $('#dtnascimento').show();
            //Apresentar campo Nome
            document.form_dados_cliente_novos.desemail.style.display = "block";
            $('#desemail').show();
            //Apresentar campo Nome
            document.form_dados_cliente_novos.desestadocivil.style.display = "block";
            $('#desestadocivil').show();
            //Apresentar campo Nome
            document.form_dados_cliente_novos.desprofissao.style.display = "block";
            $('#desprofissao').show();
            //Apresentar campo Nome
            document.form_dados_cliente_novos.dessexo.style.display = "block";
            $('#dessexo').show();
            //Apresentar campo Nome
            document.form_dados_cliente_novos.desnaturalidade.style.display = "block";
            $('#desnaturalidade').show();
            

            
            //Oculta campo Nome Fantasia
            document.form_dados_cliente_novos.desnomefantasia.style.display = "none";
            $('#desnomefantasia').hide();
            //Apresentar campo Nome Fantasia
            document.form_dados_cliente_novos.desrazaosocial.style.display = "none";
            $('#desrazaosocial').hide();
            //Oculta campo Nome Fantasia
            document.form_dados_cliente_novos.descnpj.style.display = "none";
            $('#descnpj').hide();
            //Oculta campo Nome Fantasia
            document.form_dados_cliente_novos.desie.style.display = "none";
            $('#desie').hide();
            //Oculta campo Nome Fantasia
            document.form_dados_cliente_novos.desim.style.display = "none";
            $('#desim').hide();
            //Oculta campo Nome Fantasia
            document.form_dados_cliente_novos.descontribuinte.style.display = "none";
        ...
        if (tipo == "cnpj") {
            //Apresentar campo Nome Fantasia
            document.form_dados_cliente_novos.desnomefantasia.style.display = "block";
            $('#desnomefantasia').show();
            //Apresentar campo Nome Fantasia
            document.form_dados_cliente_novos.desrazaosocial.style.display = "block";
            $('#desrazaosocial').show();
            //Apresentar campo Nome Fantasia
            document.form_dados_cliente_novos.descnpj.style.display = "block";
            $('#descnpj').show();
            //Apresentar campo Nome Fantasia
            document.form_dados_cliente_novos.desie.style.display = "block";
            $('#desie').show();
            //Apresentar campo Nome Fantasia
            document.form_dados_cliente_novos.desim.style.display = "block";
            $('#desim').show();
            //Apresentar campo Nome Fantasia
            document.form_dados_cliente_novos.descontribuinte.style.display = "block";
            $('#descontribuinte').show();
            


            //Oculta campo Nome
            document.form_dados_cliente_novos.desnome.style.display = "none";
            $('#desnome').hide();
            //Oculta campo Nome
            document.form_dados_cliente_novos.desnome.style.display = "none";
            $('#desnome').hide();
            //Oculta campo Nome
            document.form_dados_cliente_novos.descpf.style.display = "none";
            $('#descpf').hide();
            //Oculta campo Nome
            document.form_dados_cliente_novos.desrg.style.display = "none";
            $('#desrg').hide();
            //Oculta campo Nome
            document.form_dados_cliente_novos.dtnascimento.style.display = "none";
            $('#dtnascimento').hide();
            //Oculta campo Nome
            document.form_dados_cliente_novos.desemail.style.display = "none";
            $('#desemail').hide();
            //Oculta campo Nome
            document.form_dados_cliente_novos.desestadocivil.style.display = "none";
            $('#desestadocivil').hide();
            //Oculta campo Nome
            document.form_dados_cliente_novos.desprofissao.style.display = "none";
            $('#desprofissao').hide();
            //Oculta campo Nome
            document.form_dados_cliente_novos.dessexo.style.display = "none";
            $('#dessexo').hide();
            //Oculta campo Nome
            document.form_dados_cliente_novos.desnaturalidade.style.display = "none";
